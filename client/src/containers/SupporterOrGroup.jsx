        ...
        <div className={styles.container_cards}>
          <div className={styles.cardlotgenoot}>
            {!uiStore.authUser ? (
              <>
                <NavLink
                  onClick={handleClickSupporter}
                  className={styles.cardlotgenoot_navlink}
                  to={ROUTES.login}
                >
                  <p className={styles.infotext}>
                    Ik wil graag alleen deelnemen als{" "}
                    <span className={styles.lotgenoot}>supporter</span> voor een
                    lotgenoot
                  </p>
                  <p className={styles.price}>€15</p>
                  <div className={styles.container_button}>
                    <button className={styles.card_button}>
                      registreer supporter
                    </button>
                  </div>
                </NavLink>
              </>
            ...
            {!uiStore.authUser ? (
              <>
                ...
                >
                  <p className={styles.infotext}>
                    Ik wil graag{" "}
                    <span className={styles.teamcaptain}>een groep</span>{" "}
                    inschrijven voor een lotgenoot
                  </p>

                  <p className={styles.price}>vanaf €12 p.p.</p>
                  <div className={styles.container_button}>
                    <button className={styles.card_button}>
                      registreer een groep
                    </button>
                  </div>
                </NavLink>
              </>
