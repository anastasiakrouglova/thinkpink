      ...
      <div className={styles.container_signup}>
        ...
        <div>
          ...
          {/* <button className={styles.label}>
            <img src="../assets/images/icons/fotobutton.svg" alt="foto" /> Voeg
            een foto van jezelf toe
          </button>
          ...
          <div>
            <div className="App-form-input-container">
              <label htmlFor="countryNumber" className={styles.label}>
              ...
              <div>
                ...
                <input
                  name="countryNumber"
                  id="countryNumber"
                  ref={countryNumberInput}
                  className={styles.input}
                  placeholder="38 92 84 72"
                  type="password"
                />
              </div>
            </div>
          ...
          <div className={styles.buttonContainer}>
            <NavLink className={styles.secundair_button} to={ROUTES.login}>
              Log in
            </NavLink>
            <input
